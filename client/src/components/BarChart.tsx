...
export default function BarChart({ pollData }: Props) {
    ...
    return (
        <div className='p-2 flex gap-4 bg-gradient-to-t from-slate-50 to-slate-100 rounded my-5 overflow-y-auto'>

            {pollData.options?.map((opt, index) => (
                <div className='text-center w-16 mx-auto' key={`option_${index}`}>
                    <div className='relative h-72 w-14 mx-auto'>
